...
class Player: # creates player class
    ...
    def playerReply(self):
        ...
        playerreply = string.lower(raw_input("what would you like to do"))
        ...
        elif playerreply == 'unify italy' or 'unify the states of italy':
            print "i'm afraid that was already done by around 1871"
