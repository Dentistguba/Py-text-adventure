...
room3 = Location ([statuette, cheesewhizz],[exit2],"room 3",[])
...
char2 = NPC ("archduke blahoof",['deed of ownership of the land'],room3,"good day citizen")
...
player1 = Player ([cheese,key,cheesewhizz],room1,[])
